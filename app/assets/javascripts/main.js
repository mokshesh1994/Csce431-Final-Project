jQuery(document).ready(function($) {
   ...
   'use strict';
    ...
    $('#countdown').countdown({until: new Date(2017, 2-1, 19)}); // enter event day
...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 16,
        center: new google.maps.LatLng(30.61800763412226, -96.34042024612427), //change the coordinates
        mapTypeId: google.maps.MapTypeId.ROADMAP,
		scrollwheel: false,
		styles: [{featureType:'all',stylers:[{saturation:-100},{gamma:0.50}]}]
    };
    map = new google.maps.Map(document.getElementById("gmap_canvas"), myOptions);
    finaleMarker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(30.61327096711814, -96.34069450199604) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>E-Week Firday Finale</b><br/>Rudder Plaza"  //add your address
    });
    google.maps.event.addListener(finaleMarker, "click", function () {
        infowindow.open(map, finaleMarker);
    });
    infowindow.open(map, finaleMarker);
	}
